...
bool CoreSensors::serialise(ecl::PushAndPop<unsigned char> & byteStream)
{
  ...
  buildBytes(data.left_wheel, byteStream);	//2
  buildBytes(data.right_wheel, byteStream);	//2
  buildBytes(data.back_wheel, byteStream);	//1
...
bool CoreSensors::deserialise(ecl::PushAndPop<unsigned char> & byteStream)
{
  ...
  buildVariable(data.left_wheel, byteStream);
  buildVariable(data.right_wheel, byteStream);
  buildVariable(data.back_wheel, byteStream);
