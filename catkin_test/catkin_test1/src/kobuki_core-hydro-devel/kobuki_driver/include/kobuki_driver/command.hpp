...
public:
  ...
  {
    Data()
      : command(BaseControl), speed(0), radius(0), cmd_x(0), cmd_y(0), cmd_w(0), request_flags(0), gp_out(0x00f0) // set all the power pins high, others low.
  ...
  static Command SetVelocityControl(const int16_t &vx, const int16_t &vy, const int16_t &wz);
