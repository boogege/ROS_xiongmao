...
public:
  ...
  //  battery_dangerous(Battery::dangerous),
    linear_x_acceleration_limit(0.3),
    linear_x_deceleration_limit(-0.3*1.2),
    linear_y_acceleration_limit(0.3),
    linear_y_deceleration_limit(-0.3*1.2),
  ...
  double linear_x_acceleration_limit;
  double linear_x_deceleration_limit;
  double linear_y_acceleration_limit;
  double linear_y_deceleration_limit;
