...
double nav_point[10][4]={2.177,-0.007,-0.508,0.861,
2.0998,-2.27,0.994,0.1105,
0.299,-3.465,-0.763,0.647,
0.194,-4.88,0.959,0.284,   //抓 放
1.8297,-5.763,-0.436,0.8999,
-1.51,-1.882,0.551,0.835, //右抓
0.194,-4.88,0.959,0.284
};
	...
	{	
		...
		if ((current_status==3)&&(last_current_status!=current_status))
		{
			...
			switch(current_point)
			{
				...
				case 6:vel_select=RIGHT_GO;send_vel();mcu_cmd=PUT_2;sendMcu();sleep(1);vel_select=RIGHT_BACK;back=true;send_vel();back=false;break;
