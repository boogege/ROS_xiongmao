...
3.44,-4.142,-0.401,0.916,
0.412,-4.157,-0.999,0.008,
	...
	{	
		...
		if ((current_status==3)&&(last_current_status!=current_status))
		{
			...
			switch(current_point)
			{
				...
				case 2: case 3:vel_select=RIGHT_GO;send_vel();mcu_cmd=PUT_2;sendMcu();sleep(3);mcu_cmd=CATCH_2;sendMcu();vel_select=RIGHT_BACK;back=true;send_vel();back=false;break;
				case 4:case 5: case 7: vel_select=LEFT_GO;send_vel();mcu_cmd=PUT_1;sendMcu();sleep(3);mcu_cmd=CATCH_1;sendMcu();vel_select=LEFT_BACK;back=true;send_vel();back=false;break;
				case 6: mcu_cmd=DOWN;sendMcu();vel_select=LEFT_GO;send_vel();mcu_cmd=CATCH_1;sendMcu();sleep(1);mcu_cmd=UP;sendMcu();vel_select=LEFT_BACK;back=true;send_vel();back=false;break;
